...
public interface LndChainKitService {
    ...
    Single<com.github.lightningnetwork.lnd.chainrpc.GetBlockHeaderResponse> getBlockHeader(com.github.lightningnetwork.lnd.chainrpc.GetBlockHeaderRequest request);
